...
from mmpose.apis import MMPoseInferencer    # https://mmpose.readthedocs.io/en/latest/installation.html 18.01.24
...
class PoseTracker(Tracker):
    ...
    def run_frame_processor(self, port: int, rotation_count: int):
        ...
        while True:
            ...
            results = next(result_generator)['predictions'][0][0]['keypoints']
            # initialize variables so none will be created if no points detected
            point_ids = []
            landmark_xy = []
            ...
            if results:
                ...
                for landmark_id, landmark in enumerate(results):
                    point_ids.append(landmark_id)
                ...
                for i in range(16):
                    point_ids.append(i + 17)
                    landmark_xy.append((100, 100))
